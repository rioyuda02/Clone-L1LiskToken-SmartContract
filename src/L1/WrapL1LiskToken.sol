...
contract Wrap_L1LiskToken is ERC20Burnable, AccessControl, Ownable2Step, ERC20Permit {
    /// @notice Name of the token.
    string private constant NAME = "WrapLiskL1";

    /// @notice Symbol of the token.
    string private constant SYMBOL = "WLSK";

    /// @notice Total supply of the token.
    uint256 private constant TOTAL_SUPPLY = 300_000_000 * 10 ** 18; //400 million LSK tokens
